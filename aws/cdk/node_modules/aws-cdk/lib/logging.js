...
function formatMessageAndLog(level, input, ...args) {
    ...
    if (typeof input === 'string') {
        const messages = new api_private_1.IoDefaultMessages(helper);
